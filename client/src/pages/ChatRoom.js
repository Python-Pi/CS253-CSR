...
export default function ChatRoom() {
  ...
  useEffect(() => {
    fetch(
      ...
      }:8000/api/train/chats?train_number=${encodeURIComponent(
        train_number
        ...
        <div className="bg-white h-[50em] box-border font-serif">
          <div className="flex justify-center items-center wpbg min-h-[100%]">
            <div className="relative w-[87.25em] max-w-[100%] h-[calc(100vh-2.53em)] bg-white sshdw overflow-x-auto">
              <div
                className="relative flex w-full h-[3.75em]
      bg-[#ededed]"
              >
                <div className="w-[5em]">
                  <img
                    src={dp4}
                    className="ssrch h-[3.2em] w-[3.8em] pl-[0.93em] pt-[0.5em]"
                    alt="profile pic"
                  />
                </div>
                <div className="w-[18em] font-sans">
                  <div className="h-[1.5em] pt-1 text-xl">
                            ...
                            <li key={index} className="">
                              <div className="relative w-full pl-[66.5em] ml-1 mt-[0.3em] mb-[0.3em]">
                                <div className="flex -mb-2">
                                  ...
                                  <p className="mb-[-0.13em] mr-2">
                                    {message.username}
                                  </p>
                                </div>
                                <span class="top-bot"></span>
                                <span class="top-bot top-bot-border"></span>
                                <p className="justify relative right-0 mb-[0.93em] text-justify w-[17em] p-[0.75em] bg-[rgb(101,209,119)] rounded-lg overflow-hidden break-words h-fit">
                                  {newMessage}
                                </p>
                              </div>
                            </li>
                          ...
                          <>
                            <li key={index} className="">
                              <div className="relative w-full mt-[0.3em] -ml-3 mb-[0.3em]">
                                ...
                                <p className="flex justify relative right-0 mb-[0.93em] text-justify w-[17em] p-[0.75em] bg-[#5dbff6] rounded-lg break-words">
                                  {newMessage}
                                </p>
                              </div>
                            </li>
              ...
              <div className="relative flex w-full h-[3.75em] sinp justify-between flex p-[0.3em] bg-[#f0f0f0] items-center">
                <input
                  ...
                  className="relative w-[90%]  rounded-[1.8em] text-[1em] pl-4 h-[2.8em]"
          ...
          <div className="d-flex bg-[#d9dbd5] mt-[-44px] justify-content-center">
            <button className="btn  btn-primary  " onClick={handleBackPage}>
              Go Back
            </button>
          </div>
        </div>
