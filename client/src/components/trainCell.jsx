...
function TrainCell(props) {
  ...
  return (
    ...
    <div style={{ border: "2px solid black", padding: "20px", margin: "5px", borderRadius: "20px" }} className="block bg-[#FAFAFA] shadow-md shadow-gray-950">
      ...
      <div className="flex flex-row justify-start pt-4 text-xl font-semibold ">
        <div className="text-red-600 pr-40 pl-[6.7em] ml-1">Waiting: {notBooked} <button onClick={handleNotBooked} className="HSbtn p-1 py-0 ml-2 hover:bg-red-600 w-[1.5em]">+</button></div>
        <div className="text-green-600 pl-[3.8em] ml-1">Confirmed: {confirmed} <button onClick={handleBooked} className="HSbtn p-1 py-0 ml-2 w-[1.5em] hover:bg-green-600">+</button></div>
      </div>
